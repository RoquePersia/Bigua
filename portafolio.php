    ...
    <div class="container my-4">
        <div class="row">
            <div class="col-md-4">
                <div class="card bg-dark text-white">
                    <div class="card-header" style="text-align: center;">
                        <h4>Ingresar barcaza</h3>
                    </div>
                    <div class="card-body">
                        <form action="portafolio.php" method="post" enctype="multipart/form-data">
                        <div class="datos">
                                <input class="form-control mb-1" type="text" name="matricula" id="matricula" placeholder="Matricula">

                                <small id="small_label_vigencia_matricula" class="form-text text-muted">Vigencia matricula:</small>
                                <div class="row mb-4" name="datos_matricula">
                                    ...
                                    <div class="col-md-4 ps-2">
                                        <input style="display:flex; width: 100%; justify-content: center" class="btn btn-warning" type="submit" value="Vigencia" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4" name="datos_seguro">
                                    ...
                                    <small id="small_label_vigencia_seguro" class="form-text text-muted">Vigencia seguro:</small>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <input class="form-control" type="text" name="motor" id="motor" placeholder="Motor">
                                    </div>
                                    <div class="col-md-6 mb-4">
                                ...
                                <div class="datos mt-2" id="datos_persona">
                                    ...
                                    <div class="container_telefonos row mb-4" name="datos_matricula">
                                        ...
                                        <div class="col-md-6 ps-2">
                                            <input required class="form-control mb-1" type="text" name="telefono_2" id="telefono_2" placeholder="Telefono">
                                        </div>
                                    </div>
                                    <small id="small_label_vigencia_licencia" class="form-text text-muted">Vigencia licencia:</small>
                                    <input required class="form-control" type="date" name="vigencia_licencia" id="vigencia_licencia">
            ...
            <div class="col-md-8" id="div-table-container">
                <div class="card bg-dark text-white container-carga-ingreso">
                     <div class="card-header" style="text-align: center;">
                        <h2>Cargar ingreso</h1>
                    </div>
                    <div class="row card-body container-body-ingreso">
                      
                            <form class="form-busqueda-mat" action="portafolio.php" method="post" style="display: flex;">
                                <div class="col-md-3 px-1">
                                  <input required class="form-control" type="text" name="matricula" placeholder="Ingresar matricula">
                                </div>
                                <div class="col-md-3 px-1">
                                  <input required class="form-control" type="text" name="dni" placeholder="Ingresar dni">
                                </div>
                                
                                <div class="col-md-3 px-1">
                                  <input required class="form-control" type="text" name="vehiculo" placeholder="Ingresar vehículo">
                                </div>
                                <div class="col-md-3" style=" display: flex; justify-content: center;">
                                  <button class="btn btn-success" name="action" type="submit" value="cargar-ingreso" style="width: 80%;">Cargar</button>
                                </div>
                ...
                <div class="card bg-dark text-white container-carga-ingreso">
                    ...
                    <div class="row card-body container-body-ingreso">
                            ...
                            <form class="form-busqueda-mat col-md-6" action="portafolio.php" method="post" style="display: flex;">
                            ...
                            <form class="form-busqueda-lic col-md-6" action="portafolio.php" method="post" style="display: flex">
                ...
                <table class="tabla tabla-barcaza table table-striped table-dark table-hover" id="table-container" style="visibility: <?php echo $visible_mat?>;">
                    <tbody>
                    <?php ?>
                        <tr>
                            <th>Matrícula</th>
                ...
                <table class="tabla-barcaza table table-striped table-dark table-hover" id="table-container" style="visibility: <?php echo $visible_lic?>;">
                    <tbody>
                    <?php ?>
                        <tr>
                            <th>Nombre</th>
